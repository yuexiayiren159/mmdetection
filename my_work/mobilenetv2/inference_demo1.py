...
# checkpoint = load_checkpoint(model, model_pth_path, map_location='cpu')
...
def postprocess(outputs, img_path, class_names, conf_thres=0.5, iou_thres=0.4):
    ...
    boxes1 = process_yolo_output(out1, anchors1, num_classes, img_size, conf_thres, iou_thres)
    boxes2 = process_yolo_output(out2, anchors2, num_classes, img_size, conf_thres, iou_thres)
    boxes3 = process_yolo_output(out3, anchors3, num_classes, img_size, conf_thres, iou_thres)
...
# 后处理和可视化
img = postprocess(outputs, img_path, class_names)
